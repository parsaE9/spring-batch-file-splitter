...
#
      ...
      Acceptor_name				%IBAN							%Deposite_Identity		%Amount		%Trace_code							%payment_Identity
      334101541100088-سوپر مارکت	%IR450180000000004362944045		%EMPTY		%00000000001500000		%011127121208531000014525928400		%BMJSSHAP1401120211101.CT00001
